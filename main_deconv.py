...
parser.add_argument('--image_path', type=str, default='images_d')
parser.add_argument('--model_path', type=str, default='chkpts_d')
parser.add_argument('--load_path', type=str, default=None)
parser.add_argument('--up_mode', type=str, default='deconv')
